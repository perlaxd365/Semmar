...
<div class="about_area">
    <div class="whole-wrap">
        <div class="container box_1170"><div class="row">
                <div class="col-lg-5">
                        <div class="card" >
                ...
                <div class="col-lg-12">
                    <div class="about_info pl-70">
                        <div class="info_inner row">
                            <ul class="col-lg-6">
                                <li>Torno paralelo universal.</li>
                                <li>Fresa universal.</li>
                                <li>Mandrinadora horizontal de mesa.</li>
                                <li>Roladora</li>
                                <li>Cepillo de codo</li>

                           
                            </ul>
                            <ul class="col-lg-6">
                               
                            <li>Maquina de corte plazma CNC</li>
